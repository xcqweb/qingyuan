    ...
    <div class="d3ss">
        ...
        <div class="msg">
            ...
            <div class="msgBox">
                <div class="msgItem" >
                    <div class="avatar">
                        <img :src="commentProp.imgavatar"/>
                        <p>{{commentProp.name}}</p>
                        <p>来自:{{commentProp.place}}</p>
                    </div>
                    <div class="comment">
                        <vstar 
                        class='title-star'
                        ...
                        <div class="context">{{commentProp.context}}</div>
                        <div class="itemImg">
                            <img :src="commentProp.imgone"/>
                            <img :src="commentProp.imgtwo"/>
                            <img :src="commentProp.imgthree"/>
...
Vue.component('vstar',{
        ...
        template:`<ul><li class= 'clearfix' v-for='item in arr'><img :src="imgStar"/></li></ul>`,
        computed: { 
            arr:function(){
                let arrstar=[]
