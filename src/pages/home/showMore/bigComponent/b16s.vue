        ...
        <div class="buttom">
            <ul >
                ...
                <li >
                    ...
                    <div class="context">{{addPoint(yearSum)}}
                        
                    </div>
                </li>
                <li >
                    <div class="title">{{year}}年累计接待市内游客(万人)</div>
                    <div class="context">{{addPoint(yearInCitySum)}}
                ...
                <li >
                    ...
                    <div class="context">{{addPoint(monthSum)}}
                ...
                <li >
                    ...
                    <div class="context">{{addPoint(monthOutCitySum)}}
  ...
  export default {
    ...
    methods:{
        ...
        getResponse(paramsObj){
            this.$axios.get('http://120.55.190.57/qy/api/view/getInProvinceDetailData',{params:paramsObj}).then(r => {
