...
let B4 = resolve => {require.ensure(['@/pages/home/b/b41.vue'], () => {resolve(require('@/pages/home/b/b41.vue'))})}
...
//客流停留时长分析
let D12 = resolve => {require.ensure(['@/pages/home/d/d12.vue'], () => {resolve(require('@/pages/home/d/d12.vue'))})}
//景点可提升度
