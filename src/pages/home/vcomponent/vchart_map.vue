...
export default {
  ...
  data () {
    return {
        ...
        geoCoordMap:{
         ...
         BJData:[
            [{name: '清远'}, {name: '北京', value: 95.12}],
            
        ],
        GUANG:[
            [{name: '清远'}, {name: '长春', value: 40.98}],
            
        ],
        SHData:[
            [{name: '清远'}, {name: '深圳', value: 110.44}],
            
        ],
        SHENZHEN:[
            [{name: '清远'}, {name: '成都', value: 50.12}],
        ],
        XIAN:[
            [{name: '清远'}, {name: '上海', value: 85.51}],
        ],
        FENGD:[
            [{name: '清远'}, {name: '武汉', value:66.21 }]
        ],
  ...
  methods: {
    ...
    redom(){
        ...
        var series = [];
        [['浦江县', _self.BJData], ['浦江县', _self.GUANG],['浦江县', _self.SHData],['浦江县', _self.SHENZHEN],['浦江县', _self.XIAN],['浦江县', _self.FENGD]].forEach(function (item, i) {
            series.push(
                // {
                //     name: item[0],
                //     type: 'lines',
...
export default {
  ...
  data () {
    return {
        ...
        // ],
        //  var BJData =[
        //         [ {name:rankItemsMap[0].city , value: rankItemsMap[0].num/200},{name: '清远市'}],
                
        //     ];
        //     var GUANG = [
        //         [ {name:rankItemsMap[1].city , value: rankItemsMap[1].num/200},{name: '清远市'}],
                
        //     ];
        //     var SHData = [
        //         [ {name:rankItemsMap[2].city , value: rankItemsMap[2].num/200},{name: '清远市'}],
                
        //     ];
        //     var SHENZHEN = [
        //         [ {name:rankItemsMap[3].city , value: rankItemsMap[3].num/200},{name: '清远市'}],
        //     ];
        //     var XIAN = [
        //         [ {name:rankItemsMap[4].city , value: rankItemsMap[4].num/200},{name: '清远市'}],
        //     ];
        //     var FENGD = [
        //         [ {name:rankItemsMap[5].city , value: rankItemsMap[5].num/200},{name: '清远市'}],
        //     ];
        // planePath:'path://M1705.06,1318.313v-89.254l-319.9-221.799l0.073-208.063c0.521-84.662-26.629-121.796-63.961-121.491c-37.332-0.305-64.482,36.829-63.961,121.491l0.073,208.063l-319.9,221.799v89.254l330.343-157.288l12.238,241.308l-134.449,92.931l0.531,42.034l175.125-42.917l175.125,42.917l0.531-42.034l-134.449-92.931l12.238-241.308L1705.06,1318.313z',
