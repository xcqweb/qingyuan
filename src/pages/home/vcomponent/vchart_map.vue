...
export default {
  ...
  data () {
    return {
        ...
        BJData:[
            [{name: '浦江县'}, {name: '北京', value: 95}],
            
        ],
        GUANG:[
            [{name: '浦江县'}, {name: '长春', value: 40}],
            
        ],
        SHData:[
            [{name: '浦江县'}, {name: '深圳', value: 10}],
            
        ],
        SHENZHEN:[
            [{name: '浦江县'}, {name: '成都', value: 10}],
        ],
        XIAN:[
            [{name: '浦江县'}, {name: '上海', value: 95}],
        ],
        FENGD:[
            [{name: '浦江县'}, {name: '重庆', value: 20}]
        ],
