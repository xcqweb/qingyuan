		...
		data(){
			return{
				...
				qyselectlist:{
                    ...
                    selectStatus:false,
                    place:[
                        {name:'全部',num:60},{name:"清城",num:10},{name:"清新",num:10},{name:"英德",num:13},{name:"连州",num:6},{name:"佛冈",num:7},{name:"连山",num:5},{name:"连南",num:5},{name:"阳山",num:4}
                    ]
                },
                ...
                startData:["全部",'飞霞风景名胜区','牛鱼嘴原始生态风景区','天子山瀑布风景区','白庙渔村','飞来寺','美林湖及大家元摩天轮片区',
                            ...
                            '广东瑶族博物馆','古龙峡原生态旅游度假区','洞天仙境生态旅游度假区','清远市金子山旅游风景区','九州驿站英德天门沟景区','太和古洞风景区'
                ],   
	       ...
	       //类型
            ...
            const  cityData = {
               "全部":["全部",'飞霞风景名胜区','牛鱼嘴原始生态风景区','天子山瀑布风景区','白庙渔村','飞来寺','美林湖及大家元摩天轮片区',
                ...
                '黄腾峡生态旅游区','故乡里旅游度假区'],
                "清新":['全部','太和古洞旅游区','笔架山度假区','安庆村','清泉湾生态旅游度假区','金龙洞','九牛洞村','清新温矿泉旅游度假区','玄真古洞生态旅游区','古龙峡原生态旅游度假区','太和古洞风景区',],
		...
		computed:{
			comQyselectlist(){
				if(this.type==='景区'){
					...
					this.qyselectlist.place = [
                        {name:'全部',num:104},{name:"清城",num:36},{name:"清新",num:12},{name:"英德",num:12},{name:"连州",num:13},{name:"佛冈",num:12},{name:"连山",num:7},{name:"连南",num:2},{name:"阳山",num:10}
                    ]
					return this.qyselectlist
				}
			},
